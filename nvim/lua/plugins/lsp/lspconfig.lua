return {
  ...
  config = function()
    ...
    local on_attach = function(client, bufnr)
      ...
      keymap.set("n", "<leader>D", "<cmd>Telescope diagnostics bufrn=0<CR>", opts) -- show diagnostics for file
    ...
    -- configure typescript/javascript server with plugin
    ...
    -- configure lua server with plugin
    lspconfig["lua_ls"].setup({
      ...
      settings = {
        ...
        Lua = {
          ...
          workspace = {
            -- make language server aware for runtime files
            library = {
